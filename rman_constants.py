...
BLENDER_PYTHON_VERSION = "3.7"
if BLENDER_VERSION_MAJOR > 2:
    BLENDER_PYTHON_VERSION = "3.9"
elif BLENDER_VERSION_MAJOR == 2 and BLENDER_VERSION_MINOR >= 93:
    BLENDER_PYTHON_VERSION = "3.9"

RMAN_SUPPORTED_VERSION_MAJOR = 24
RMAN_SUPPORTED_VERSION_MINOR = 4
